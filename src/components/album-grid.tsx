...
// ── Team colours — flag-accurate gradients for all 48 teams ──
// [gradientTop, gradientBottom]
const TEAM_COLORS: Record<string, readonly [string, string]> = {
  // Intro / Museum
  'Introdução':           ['#1a1a2e', '#16213e'],
  'FIFA Museum':          ['#7c3f00', '#b05a00'],

  // 48 seleções Copa 2026
  'México':               ['#006847', '#CE1126'],
  'África do Sul':        ['#007A4D', '#002395'],
  'Coreia do Sul':        ['#C60C30', '#003478'],
  'República Checa':      ['#D7141A', '#11457E'],
  'Canadá':               ['#CC0000', '#FF0000'],
  'Bósnia e Herzegovina': ['#002395', '#C09B00'],
  'Qatar':                ['#6B1530', '#8D1B3D'],
  'Suíça':                ['#9B0000', '#D40000'],
  'Brasil':               ['#009C3B', '#C8A400'],
  'Marrocos':             ['#006233', '#C1272D'],
  'Haiti':                ['#00209F', '#D21034'],
  'Escócia':              ['#003DA5', '#005EB8'],
  'EUA':                  ['#3C3B6E', '#B22234'],
  'Paraguai':             ['#D52B1E', '#002B7F'],
  'Austrália':            ['#00008B', '#B8860B'],
  'Turquia':              ['#C8000A', '#E30A17'],
  'Alemanha':             ['#1a1a1a', '#CC0000'],
  'Curaçao':              ['#002B7F', '#C8A800'],
  'Costa do Marfim':      ['#F77F00', '#009A44'],
  'Equador':              ['#8B6900', '#003087'],
  'Países Baixos':        ['#AE1C28', '#E55000'],
  'Japão':                ['#8B001A', '#BC002D'],
  'Suécia':               ['#004B87', '#FECC02'],
  'Tunísia':              ['#9B0010', '#E70013'],
  'Bélgica':              ['#1a1a1a', '#EF3340'],
  'Egipto':               ['#9B0010', '#1a1a1a'],
  'Irão':                 ['#239F40', '#DA0000'],
  'Nova Zelândia':        ['#1a1a1a', '#CC0000'],
  'Espanha':              ['#AA151B', '#C8A000'],
  'Cabo Verde':           ['#003893', '#CF2027'],
  'Arábia Saudita':       ['#004A25', '#006C35'],
  'Uruguai':              ['#003DA5', '#5B9BD5'],
  'França':               ['#002395', '#ED2939'],
  'Senegal':              ['#00853F', '#C8A800'],
  'Iraque':               ['#007A3D', '#CE1126'],
  'Noruega':              ['#EF2B2D', '#002868'],
  'Argentina':            ['#003DA5', '#5B9BD5'],
  'Argélia':              ['#006233', '#D21034'],
  'Áustria':              ['#C00000', '#ED2939'],
  'Jordânia':             ['#007A3D', '#1a1a1a'],
  'Portugal':             ['#006600', '#C80000'],
  'Congo RD':             ['#007FFF', '#CE1126'],
  'Uzbequistão':          ['#0099B5', '#1EB53A'],
  'Colômbia':             ['#7A6000', '#003087'],
  'Inglaterra':           ['#CF091F', '#012169'],
  'Croácia':              ['#CC0000', '#003DA5'],
  'Gana':                 ['#006B3F', '#1a1a1a'],
  'Panamá':               ['#D21034', '#002B7F'],
}
const DEFAULT_COLORS: readonly [string, string] = ['#2d1b69', '#4c1d95']
